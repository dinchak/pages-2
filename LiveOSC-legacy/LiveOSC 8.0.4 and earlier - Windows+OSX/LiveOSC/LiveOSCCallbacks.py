...
class LiveOSCCallbacks:
    ...
    def deviceCB(self, msg):
        ...
        if len(msg) == 4:
            ...
            self.oscServer.sendOSC(ty == 1 and "/live/return/device" or "/live/device", tuple(po))
            ...
            self.oscServer.sendOSC(ty == 1 and "/live/return/device" or "/live/device", (track, device, param, p.value, str(p.name)))
